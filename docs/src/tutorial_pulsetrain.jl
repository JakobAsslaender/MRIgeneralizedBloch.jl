...
s_linapp, _ = calculatesignal_linearapprox(α, TRF, TR, ω0, B1, 1, m0s, R1f, R2f, Rex, R1s, T2s, R2slT; grad_moment)
...
m_linapp, _ = calculatesignal_linearapprox(α, TRF, TR, ω0, B1, 1, m0s, R1f, R2f, Rex, R1s, T2s, R2slT;
...
s_linapp, _ = calculatesignal_linearapprox(α, TRF, TR, ω0, B1, 1, m0s, R1f, R2f, Rex, R1s, T2s, R2slT; grad_list, grad_moment);
...
R1a = 1 # 1/s
grad_list = (grad_R1a(),)
s_linapp, _ = calculatesignal_linearapprox(α, TRF, TR, ω0, B1, 1, m0s, R1a, R2f, Rex, R1a, T2s, R2slT; grad_list, grad_moment)
