"""
    precompute_R2sl([;TRF_min=100e-6, TRF_max=500e-6, T2s_min=5e-6, T2s_max=15e-6, ω1_max=π/TRF_max, B1_max=1.5, greens=greens_superlorentzian])
...
```
"""
function precompute_R2sl(;TRF_min=100e-6, TRF_max=500e-6, T2s_min=5e-6, T2s_max=15e-6, ω1_max=π/TRF_max, B1_max=1.5, greens=greens_superlorentzian)
